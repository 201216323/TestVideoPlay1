package bruce.chang.testvideoplay1;
 ...
 * Date on : 2017/1/4.
 * Time on: 14:03
 * Progect_Name:TestVideoPlay1
 * Source Github：https://github.com/maning0303
 * Description:自定义组件实现视频播放+横竖屏切换
 */
public class MainActivity extends AppCompatActivity {

    private static final String TAG = "MNViderPlayer";
    private final String url1 = "http://v1.mukewang.com/488eb60c-5fad-4dfd-bb6d-e98b02893b78/M.mp4";
    ...
    private void initPlayer() {
        ...
        //第一次进来先设置数据
        mnViderPlayer.setDataSource(url1, "Android百度地图之定位功能");
    ...
    public void btn01(View view) {
        mnViderPlayer.playVideo(url1, "Android百度地图之定位功能");
    }
